...
function displayRecipes(data) {
    ...
    //    console.log (myrecipe);
       ...
       var divTitle = "#recipe-title-"+index;
        ...
        $(divId).append("<img class='recipeImages w-75' id='img_"+(results[index].id)+"' src='"+results[index].imageUrlsBySize[90].slice(0, -6) +"'/>");
...
$(".side-recipe-div").on("click", function () {
    ...
    /* if (ingredientsList.length > 0) {
        for (index in ingredientsList) {
           ...
           $("#main-recipe-ingredients").append(tableRow);
        }
